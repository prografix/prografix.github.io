...
// Заполнение многогранника с двойственным преобразованием
    ...
    for ( i = 0; i < nf; ++i )
    {
        ...
        // Заполнение вершин многогранника
    ...
    // Определение порядка вершин в гранях
    quickSort123 ( arr );
    ...
    // Заполнение граней многогранника
