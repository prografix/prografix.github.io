...
//    Def<Circle3d> fig = maxCircleInConvexPolyhedron ( poly );
//    Def<Triangle3d> fig = maxTriangleInConvexPolyhedronA ( poly );
    Def<Ellipse3d> fig = maxEllipseInConvexPolyhedronA ( Spin3d (), poly );
    double t1 = timeInSec();
    draw ( poly, 0, 1, 1, 1, VM_WIRE );
