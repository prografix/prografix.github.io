...
class GIStorage : public GraphicInterface
{
    GIStorage ( const GIStorage & );
    void operator = ( const GIStorage & );
// Data
    union Node * data, * freeNode, * curBlock;
    int nPtr, maxPtr;
    void ** ptrArr;
// Methods
    void put ( OpCode code );
    unsigned char * putArray ( int n, const unsigned char * arr );
    Node * getNodes ( int n );
...
// Get
    void GetFloatModelViewMatrix ( GIuint index );
    void GetFloatProjectionMatrix ( GIuint index );
...
// Quadric objects
	...
	void Sphere ( float radius, int slices, int stakes );
/////////////////////////////////////////////////////////////////////
//                                                                 //
