...
class GLDevice : public GraphicInterface
{
    const Node * nextStart;
    class GLUquadric * quadObj;
    float * floatValue;
    GIuint floatValueSize;
    int * intValue;
    GIuint intValueSize;
    void resizeIntValue ( GIuint n );
    void resizeFloatValue ( GIuint n );
    const Node * getNextStart() const;
public:
/////////////////////////////////////////////////////////////////////
//                                                                 //
//                   Graphical commands                            //
